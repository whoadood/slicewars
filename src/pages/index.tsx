...
export default function Tester() {
  ...
  return (
    <>
      <Head>
        <title>Slicewars</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta
          name="description"
          content="vote on your favorite local pizza shops"
        />
      </Head>
      ...
      <div className="flex items-center relative flex-col justify-center sm:translate-y-1/2">
        ...
        <div className="relative">
          ...
          <ul className="flex gap-8 sm:gap-20 flex-col sm:flex-row">
            {restaurants && !restaurantContext?.restIsLoading ? (
              restaurants?.map((business) => (
                ...
                >
                  ...
                  <div className="min-h-[200px] min-w-[250px] mt-4 relative flex overflow-hidden">
                    <Image
              ...
              <div className="flex justify-center items-center min-h-[20vh]">
                <h2 className="text-2xl px-6">
                  This application requires access to your device location in
